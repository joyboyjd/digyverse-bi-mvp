...
export default function IngestionPage() {
  ...
  const handleSyncComplete = (data: { importedRows: number; sourceFile: string }) => {
    // Sync complete logic disconnected from page.tsx for now
  };
